...
### 19.1. `database/migrations/xxxx_create_reading_plans_table.php`
...
### 19.2. `database/migrations/xxxx_create_notifications_table.php`
...
### 19.3. `app/Enums/ReadingPlanStatus.php`
...
### 19.4. `app/Models/ReadingPlan.php`
...
### 19.5. `database/factories/ReadingPlanFactory.php`
...
### 19.6. `app/Policies/ReadingPlanPolicy.php` と AuthServiceProvider 登録
...
### 19.7. `app/Http/Requests/{Store,Update}ReadingPlanRequest.php`
...
### 19.8. `app/Notifications/PlanReminderNotification.php`
...
### 19.9. `app/Console/Commands/RunReadingPlanDailyBatch.php` と Console Kernel
...
### 19.10. `app/Http/Controllers/ReadingPlanController.php`
...
### 19.11. `app/Http/Controllers/NotificationController.php`
...
### 19.13. `resources/views/layouts/navigation.blade.php`（提供済の確認）
...
### 19.14. `database/seeders/ReadingPlanSeeder.php` と DatabaseSeeder 登録
