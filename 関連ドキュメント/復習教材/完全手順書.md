...
> **注:** 本セクションは Part 2 で実装したコードへの「品質追加」の手順です。各既存ファイルを上記の変更内容に従って編集してください。テストが既に Basic 段階で書かれている場合は、`sail artisan test` で全テストが Pass することを確認してから Step 16 に進んでください。
