...
| reviews | id, user_id(FK), book_id(FK), rating(tinyInt), comment(nullable) | unique(user_id, book_id)、CASCADE |
...
### 5.1. `database/seeders/GenreSeeder.php`
...
### 5.2. `database/seeders/UserSeeder.php`
...
class GenreTest extends TestCase
{
    ...
    public function test_genre_show_page_displays_books(): void
    {
        ...
        $book->genres()->attach($genre);
        $this->get(route('genres.show', $genre))->assertOk()->assertSee('Mystery Book');
    }
