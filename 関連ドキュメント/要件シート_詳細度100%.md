...
| Api\V1\StoreBookRequest<br>Api\V1\UpdateBookRequest<br>（API版・Basic 以降） | Web版と概ね同等。API版は isbn / published_date を required で維持するため、以下のメッセージを追加で定義：<br>isbn.required: ISBNは必須です。<br>published_date.required: 出版日は必須です。 |
