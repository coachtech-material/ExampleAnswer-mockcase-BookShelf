            ...
            <div class="bg-gradient-to-br from-indigo-50 to-blue-50 border border-indigo-100 shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <div class="flex gap-2">
                        <input type="text" id="isbn-search" placeholder="例: 9784101010014"
                               class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm"
                               maxlength="13" inputmode="numeric">
                        <button type="button" id="fetch-btn" class="inline-flex items-center gap-1 bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 text-white text-sm font-semibold py-2 px-4 rounded-md shadow-sm transition">
