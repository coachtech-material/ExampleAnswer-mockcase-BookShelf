            ...
            <div class="bg-gradient-to-br from-indigo-50 to-blue-50 border border-indigo-100 shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <div class="flex gap-2 w-full">
                        ...
                        <button type="button" id="fetch-btn" class="shrink-0 inline-flex items-center gap-1 bg-blue-500 hover:bg-blue-700 disabled:bg-blue-300 text-white text-sm font-bold py-2 px-4 rounded shadow-sm transition">
